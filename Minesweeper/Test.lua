...
----------Credits----------
fixed by n4vq
Original Creator: NothingNesser
------Original Script------
Main issue: Bad Maintainability
including ass way of running it.
----------Updates----------
Refresh Rate for Run to prevent FPS drops
Range Fixed
Auto-Flag patched, going to find a bypass for that later
------Current Issues-------
Run bugging out randomly, changing to percentages all of a sudden and then going back having issues figuring out what is a bomb and what is a safe tile (critical)
----------Accuracy----------
94%
]])
